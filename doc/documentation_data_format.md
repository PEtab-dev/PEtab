...
* (optional)  A simulation file, which has the same format as the measurement file, but contains model simulations

* (optional) A visualization file, which contains specifications how the data and/or simulations should be plotted by the visualization routines
...
Extensions of this format (e.g. additional columns in the measurement table) are possible and intended. Those columns may provide extra information, e.g., for plotting, or for parameter estimation, but they should not influence the global optimum of the optimization problem. Some of these optional extensions are described in the last section ("Extensions") of this document.
...
## Visualization table
A tab-separated value file containing the specification of visualizations.
